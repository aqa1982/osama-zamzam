...
\033[1;96m   ████   ███████ ██   ██ ██      ██ ██   ██       
  AUTHOR   :   OSAMA HACKER
  FACEBOOK :   OSAMA-ZAMZAM
  GITHUB    :   LB OSAMA
  LIFE STATUS  :  OSAMA-1982
  FB GROUP  : OSAMA HACKER 0001
  TOOL STATUS :  FREE                             
\033[1;91m=========================================================="""
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop += 1
        sys.stdout.write(f'\r\33[1;37m[OSᗩᗰᗩ ] [%s]\33[1;97m [OK:%s~CP:%s]' % (loop, len(oks), len(cps))),
        sys.stdout.flush()
        checks(oks, cps, twf)
    except:
        pass
