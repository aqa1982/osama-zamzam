...
| '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'                                          
 \033[1;90m══════════════════════════════════════════════════
 \033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : OSAMA-ZAMZAM   
 \033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFB GROUP : LB OSAMA
 \033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : OSAMA-1982
 ...
 \033[1;90m══════════════════════════════════════════════════
     """)
        ...
        print("%s [%s6%s]%s CRACK RANDOM FB ID 2004-6 %s(FREE) V2" % (R, G, R, Y, G))
        print("%s [%s7%s]%s CRACK RANDOM FB ID 2004-5 %s(FREE) V3" % (R, G, R, Y, G))
        print("%s [%s8%s]%s CRACK RANDOM FB ID 2003-4 %s(FREE FRESH) V3" % (R, G, R, Y, G))
    ...
    def api(self, uid, pwx):
        ...
        sys.stdout.write(
            "\r\r %s[>_] [BY] : %s/%s -> \033[0;92m [ BY-OK:%s ]- \033[0;91m[BY-CP:%s ]" % (
